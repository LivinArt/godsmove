...
export const WalletCreditedTemplate: React.FC<WalletCreditedTemplateProps> = ({
...
export default WalletCreditedTemplate;
...
const amountStyle = { fontSize: '24px', fontWeight: 800, color: '#22c55e', margin: '0' };
